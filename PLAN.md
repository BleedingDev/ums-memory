...
- Has _confidence_, _decay_, _evidence_, _scope_.
...
7. **Observability:** every recall explains _why_ it was retrieved.

---

# 3) Conceptual Data Model (no schema yet)

> We intentionally avoid a concrete DB schema in this phase. We only define _conceptual entities_ and invariants.
...
- easy to call from agents _and_ web chat wrappers.
...
Even if episodes grow, we can keep _associative recall_ stable via:
