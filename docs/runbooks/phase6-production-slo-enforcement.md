...
## Inputs
Required:
- One or more KPI dashboard JSON files (`pilot_kpi_dashboard.v1`) from `npm run pilot:dashboard`.

Optional:
- One tuning recommendation JSON file (`pilot_ranking_decay_tuning.v1`) from `npm run pilot:tune`.
