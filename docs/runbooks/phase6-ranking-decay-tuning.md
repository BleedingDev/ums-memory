...
- One or more pilot summary JSON files (`pilot_rollout_report.v1`) from `bun run pilot:report`.

Optional:

- KPI dashboard JSON (`pilot_kpi_dashboard.v1`) from `bun run pilot:dashboard`.
