...
Generated at: 2026-03-01T04:50:34.676Z
...
| metric | p50 | p95 | max |
| --- | ---: | ---: | ---: |
| ingest (ms) | 0.0015 | 0.0029 | 0.3672 |
| replay (ms) | 0.0009 | 0.0011 | 0.5335 |
| recall (ms) | 2.2284 | 3.5916 | 7.1292 |
...
| metric | p50 | p95 | max |
| --- | ---: | ---: | ---: |
| ingest (ms) | 0.0018 | 0.0042 | 0.3672 |
| replay (ms) | 0.0009 | 0.0016 | 0.3951 |
| recall (ms) | 2.2715 | 3.7833 | 7.1292 |
...
| metric | p50 | p95 | max |
| --- | ---: | ---: | ---: |
| ingest (ms) | 0.0014 | 0.0018 | 0.0344 |
| replay (ms) | 0.0009 | 0.001 | 0.5335 |
| recall (ms) | 2.1193 | 2.8288 | 6.0197 |
