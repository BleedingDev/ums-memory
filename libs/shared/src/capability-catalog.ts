...
const P1_CAPABILITIES: Capability[] = [
  {
    id: "P1-00",
    ...
    intent:
      "Stand up backend-first project architecture and shared domain contracts.",
  },
  {
    id: "P1-01",
    ...
    intent:
      "Implement deterministic z_(t+1)=Phi(z_t,x_t,delta_t) state transitions.",
  },
  {
    id: "P1-02",
    ...
    intent:
      "Provide explicit memory layer models and transitions across layers.",
  },
  {
    id: "P1-03",
    ...
    intent:
      "Define entities, invariants, and error semantics for memory safety.",
  },
  {
    id: "P1-04",
    ...
    intent:
      "Establish stable command and JSON contracts for tool integrations.",
  },
  {
    id: "P1-05",
    ...
    intent:
      "Support trusted, replay-safe ingestion with sanitization boundaries.",
  },
  {
    id: "P1-06",
    ...
    intent:
      "Support short-term buffering and deterministic consolidation into long-term memory.",
  },
  {
    id: "P1-07",
    ...
    intent:
      "Generate structured, traceable working-memory digests from episodes.",
  },
  {
    id: "P1-08",
  ...
  },
  {
    ...
    intent:
      "Apply procedural memory deltas deterministically and incrementally.",
  },
  {
    id: "P1-11",
    ...
    intent:
      "Support confidence decay, tombstones, and harmful guidance inversion.",
  },
  {
    id: "P1-12",
    ...
    intent:
      "Return bounded recall packs with evidence, freshness, and conflict notes.",
  },
  {
    id: "P1-13",
  ...
  },
  {
    ...
    intent:
      "Provide resilient storage/index abstractions for local-first portability.",
  },
  {
    id: "P1-15",
    ...
    intent:
      "Instrument health, audit, and drift signals for continuous reliability.",
  },
];

const P2_CAPABILITIES: Capability[] = [
  {
    id: "P2-00",
    ...
    intent:
      "Provide enterprise adapter contracts for source-specific integrations.",
  },
  {
    id: "P2-01",
    ...
    intent:
      "Ingest and reconcile Jira issues with strong provenance and replay safety.",
  },
  {
    id: "P2-02",
    ...
    intent:
      "Provide connector scaffolding for heterogeneous ticketing systems.",
  },
  {
    id: "P2-03",
  ...
  },
  {
    ...
    intent:
      "Ingest chat transcripts and proxy event streams across chat providers.",
  },
  {
    id: "P2-05",
  ...
  },
  {
    ...
    intent:
      "Enforce trust boundaries and provenance checks across integrations.",
  },
  {
    id: "P2-08",
    ...
    intent:
      "Guarantee idempotent ingestion and replay-safe processing at scale.",
  },
  {
    id: "P2-09",
    ...
    intent:
      "Represent chronological truth changes and conflict resolution notes.",
  },
  {
    id: "P2-10",
  ...
  },
  {
    ...
    intent:
      "Rank recall candidates across sources with deterministic heuristics.",
  },
  {
    id: "P2-12",
  ...
  },
  {
    ...
    intent:
      "Maintain bounded latency, storage, and compute costs at enterprise scale.",
  },
  {
    id: "P2-15",
    ...
    intent:
      "Support staged rollout, migration, and historical backfill reliability.",
  },
];

export const CAPABILITY_CATALOG = Object.freeze(
  [...P1_CAPABILITIES, ...P2_CAPABILITIES].map((capability) =>
...
export function getCapabilitiesByPhase(phase: string): Capability[] {
...
export function findCapability(
  ...
  return (
    CAPABILITY_CATALOG.find((capability) => capability.id === capabilityId) ??
    null
  );
}
