...
function printUsage() {
  process.stdout.write(
    [
      "Usage:",
      "  node scripts/validate-vector-retrieval-evaluation.mjs [--file <path>] [--json]",
      "",
      "Options:",
...
export async function main(argv = process.argv.slice(2)) {
  ...
  try {
    const result = await validateVectorRetrievalEvaluation({ runbookPath: parsed.runbookPath });
